...
public class MainActivity extends Activity
{
    ...
    private static String SENDER_ID = "148838745161";
    ...
    public void onClickRegDevice(View view)
    {
        ...
        // and thus check whether app is already registered or not.
    ...
    private String getRegistrationId(Context context)
    {
        ...
        // since the existing regID is not guaranteed
        // to work with the new app version.
